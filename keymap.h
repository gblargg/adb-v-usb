...
static const uint8_t PROGMEM keymap_extended [1] [16] [8] = {
    KEYMAP_EXTENDED_US(
...
static const uint8_t PROGMEM keymap_compact [1] [16] [8] = {
    KEYMAP_M0116(
                             NO,
...
static const uint8_t (*keymap) [16] [8] = keymap_extended;

static void init_keymap( uint8_t keyboard_id )
{
	switch ( keyboard_id )
	{
	case 0x08: // M0487
